 ...
 *  
 */
public class FreemarkerStepDialog extends BaseStepDialog implements StepDialogInterface {
   ...
   */
  private static Class<?> PKG = FreemarkerStepMeta.class; // for i18n purposes  

  // this is the object the stores the step's settings
  // the dialog reads the settings from it when opening
  // the dialog writes the settings to it when confirmed  
  private FreemarkerStepMeta meta;
   ...
   */
  public FreemarkerStepDialog( Shell parent, Object in, TransMeta transMeta, String sname ) {
    super( parent, (BaseStepMeta) in, transMeta, sname );
    meta = (FreemarkerStepMeta) in;
  }
  ...
  public String open() {
    ...
    shell.setText( BaseMessages.getString( PKG, "Freemarker.Shell.Title" ) );
    ...
    wHelloFieldName = new LabelText( shell, BaseMessages.getString( PKG, "Freemarker.FieldName.Label" ), null );
