...
@Step(
  id = "FreemarkerStep",
  name = "FreemarkerStep.Name",
  description = "FreemarkerStep.TooltipDesc",
  image = "org/pentaho/di/sdk/steps/freemarker/resources/demo.svg",
  categoryDescription = "i18n:org.pentaho.di.trans.step:BaseStep.Category.Transform",
  i18nPackageName = "org.pentaho.di.sdk.steps.freemarker",
  documentationUrl = "FreemarkerStep.DocumentationURL",
  casesUrl = "FreemarkerStep.CasesURL",
  forumUrl = "FreemarkerStep.ForumURL"
  )
@InjectionSupported( localizationPrefix = "FreemarkerStepMeta.Injection." )
public class FreemarkerStepMeta extends BaseStepMeta implements StepMetaInterface {
  ...
  public StepDialogInterface getDialog( Shell shell, StepMetaInterface meta, TransMeta transMeta, String name ) {
    return new FreemarkerStepDialog( shell, meta, transMeta, name );
  }
  ...
  public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr, TransMeta transMeta,
      Trans disp ) {
    return new FreemarkerStep( stepMeta, stepDataInterface, cnr, transMeta, disp );
  }
